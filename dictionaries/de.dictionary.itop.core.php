...
Dict::Add('DE DE', 'German', 'Deutsch', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Ein (kleines) Bild verlinken, das die Applikation repräsentiert, mit der TeemIp synchronisiert wird',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hyperlink zur Applikation',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink zum TeemIp Objekt in der externen Applikation mit der TeemIp synchronisiert wird (falls anwendbar). Mögliche Platzhalter: $this->attribute$ und $replica->primary_key$',
