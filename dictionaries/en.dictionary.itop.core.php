...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hyperlink a (small) image representing the application with which TeemIp is synchronized',
	'Class:SynchroDataSource/Attribute:url_application' => 'Application\'s hyperlink',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink to the TeemIp object in the external application with which TeemIp is synchronized (if applicable). Possible placeholders: $this->attribute$ and $replica->primary_key$',
