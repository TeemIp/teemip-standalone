...
Special Thanks To:
------------------
Molkobain for his nice datacenter view and background tasks control center extensions.
...
Localization
------------
teemIP is available in Chinese (simplified), English, French, German, Italian, Portuguese (Brazilian) and Spanish!

Because teemIP relies on iTop and because iTop is available in 15 different languages, teemIP could be available within
the same languages at a translation cost that is not too high. Indeed, around 4000 entries that are specific to
teemIP modules need to be translated. Should you volunteer to translate teemIP modules or correct and complete existing
dictionaries, just create and submit pull requests on GitHub. You may as well contact xtophe38@users.sourceforge.net to
discuss your translation project.
