...
EOF
		...
		$oPage->add('<div><a href="http://www.teemip.net" title="www.teemip.net" target="_blank"><img src="' . utils::GetAbsoluteUrlAppRoot() . 'images/logos/logo-combodo-dark.svg?t='.utils::GetCacheBusterTimestamp().'"/></a></div>');
